    ...
    try {
      ...
      if (
        ...
        setErrorMessage((prevErrors) => [
          ...prevErrors,
          "URL does not seem to be an RSS feed. ",
        ]);
        isPassed = false;
        return;
      }
      ...
      if (channelTag.length === 0) {
        setErrorMessage((prevErrors) => [
          ...prevErrors,
          "RSS feed does not contain a channel tag. ",
        ]);
        isValid = false;
        isPassed = false;
      }
      ...
      if (itemTag.length === 0) {
        setErrorMessage((prevErrors) => [
          ...prevErrors,
          "channel Tag contains no item elements. ",
        ]);
        isValid = false;
        isPassed = false;
      }
  ...
  return (
    <div>
      ...
      <div className="CSV-link">
        <Button variant="outlined" color="primary" onClick={gotoCSV}>
          Upload a CSV File
        </Button>
      </div>
      ...
      <div className="http-message">
        {httpMessage && <div>{httpMessage}</div>}
      </div>
    </div>
  );
};
